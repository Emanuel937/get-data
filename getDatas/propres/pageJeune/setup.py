...
class Goto():
    ...
    def getData(self, element_len):
        try:
            parent = self.driver.find_elements_by_css_selector(".bi-list")[element_len]
    ...
    def getAllElement(self):
        try:
            allElements = self.driver.find_elements_by_css_selector(".bi-list")
    ...
    def get_from_all_france(self):
        try:
            ...
            while(True):
                    if isinstance(self.start, int) and self.start < 10 :
